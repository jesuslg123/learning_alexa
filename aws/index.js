...
const StopNumberHandler = {
  ...
  handle(handlerInput) {
    ...
    const stopInfo = handlerInput.requestEnvelope.request.intent.slots.stopNumber.value + ", la línea 22 llega en " + i + " minutos";
    const speechOutput = GET_STOP_MESSAGE + stopInfo;

    return handlerInput.responseBuilder
      .speak(speechOutput)
      .reprompt(HELP_REPROMPT)
      .withSimpleCard(SKILL_NAME, stopInfo)
      .getResponse();
  },
};
